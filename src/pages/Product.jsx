...
const Product = () => {
  return (
    <Container>
      ...
      <Wrapper>
        <ImgContainer>
          <Image src="https://5.imimg.com/data5/SELLER/Default/2021/11/LB/FH/HF/141029122/sony-playstation-5-digital-edition-825gb-1000x1000.png" />
        </ImgContainer>
        <InfoContainer>
          <Title>PlayStation 5 with Controller</Title>
          <Desc>
          ...
          <FilterContainer>
            ...
            <Filter>
              ...
              <FilterSize>
                <FilterSizeOption>Stock</FilterSizeOption>
                <FilterSizeOption>Digital Version</FilterSizeOption>
              </FilterSize>
            </Filter>
          </FilterContainer>
          <AddContainer>
